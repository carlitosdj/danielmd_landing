      ...
      <div style={{ maxWidth: '100%', margin: '0 auto', padding: '0' }}>
        <div className="container-modern">
          <div className="section-header">
            ...
            <p className="section-subtitle">Encontre facilmente o local da festa e venha celebrar conosco! 🎉</p>
          </div>
        </div>
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                ...
                <span style={{ fontSize: '0.9rem' }}>Estacionamento disponível no local</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <span style={{ fontSize: '1.2rem' }}>🚌</span>
                <span style={{ fontSize: '0.9rem' }}>Acesso por transporte público</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <span style={{ fontSize: '1.2rem' }}>⏰</span>
                <span style={{ fontSize: '0.9rem' }}>Chegue com antecedência</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <span style={{ fontSize: '1.2rem' }}>📱</span>
                <span style={{ fontSize: '0.9rem' }}>Tenha o endereço salvo no celular</span>
              </div>
            </div>
          </div>
        </div>
